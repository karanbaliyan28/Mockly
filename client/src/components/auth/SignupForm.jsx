...
const SignupForm = () => {
  const { userInput, setUserInput, signupUser, loading, error, success } = useSignupStore();
    ...
    <div className="w-full max-w-md">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-600 dark:text-slate-400">to start your AI interview journey</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-6">
          <FormInput id="username" label="Username" type="text" value={userInput.username} onChange={handleChange} />
          <FormInput id="fullName" label="Full Name" type="text" value={userInput.fullName} onChange={handleChange} />
          <FormInput id="email" label="Email Address" type="email" value={userInput.email} onChange={handleChange} />
          <FormInput id="graduationYear" label="Graduation Year" type="number" value={userInput.graduationYear} onChange={handleChange} />
